...
UI-02 is **not globally LOCKED** merely because individual technical/runtime fixes passed. Visual acceptance remains a separate Project Owner acceptance gate.
